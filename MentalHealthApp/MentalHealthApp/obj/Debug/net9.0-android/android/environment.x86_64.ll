...
@dso_cache = dso_local local_unnamed_addr global [52 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x22a7b315de8342b7, ; from name: libsqlite3
		i64 u0x8eb82da4a8f63df5, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.12_name, ; name: libsqlite3.so
		ptr null; void* handle
	}, ; 9
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x36d5d76aa42df590, ; from name: sqlite3.so
		i64 u0x8eb82da4a8f63df5, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.12_name, ; name: libsqlite3.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x6749fe61899da407, ; from name: sqlite3
		i64 u0x8eb82da4a8f63df5, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.12_name, ; name: libsqlite3.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x8eb82da4a8f63df5, ; from name: libsqlite3.so
		i64 u0x8eb82da4a8f63df5, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.12_name, ; name: libsqlite3.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [32 x i8] c"com.companyname.mentalhealthapp\00", align 16
...
@.DSOCacheEntry.12_name = private unnamed_addr constant [14 x i8] c"libsqlite3.so\00", align 1
